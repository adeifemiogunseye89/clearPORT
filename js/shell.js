...
function showToast(title, msg, ok) {
  clearTimeout(_toastTimeout); // a second toast firing before the first one's 3.8s elapses would otherwise have it dismissed early
  ...
  _toastTimeout = setTimeout(()=>t.classList.remove('on'), 3800);
}
